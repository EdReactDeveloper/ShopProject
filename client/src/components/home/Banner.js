	...
	return (
		<div className="banner">
			<div className="container">
              ...
              <FormattedMessage id="lorem" defaultMessage="lorem Ipsum is just a dummy text of the priniting and the typesitting industrt" />			
							</div>
						</div>
						<div className="banner-pricebox">
							<div className="banner-price">
									<FormattedMessage id="price" defaultMessage="price" />: $120</div>
